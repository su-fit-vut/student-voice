...
Samozřejmě že ne! GitHub jsme si vybrali proto, že systém issue umožnuje přehlednou organizovanou diskuzi, kategorizaci pomoci tagů a snadné vyhledávání. Každý student FITu je programátor a většina programátorů má na GitHubu účet. Odpadá tak potřeba registrace na vaší straně a uchovávání dat o uživatelích na té naší.

K čemu je ale repozitář, když je takřka prázdný. Určitě se vám jako programátorům podařilo napsat kód s hloupou chybou, která vás buď pobavila, nebo jste nad jejím hledáním probděli pár nocí. Pomocí pull requestu nám můžete takové kódy poskytnout, ideálně okomentované. (Struktura repozitáře bude upřesněna)
